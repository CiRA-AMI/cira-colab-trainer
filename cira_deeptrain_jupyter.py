...
testsetGroup = Box([HTML("<h1 class='text-xl font-bold'>● Data test</h1>"), fcTestImgFolder, btReloadTestset], layout=Layout(display="flex", flex_flow="column", padding="0"))
...
runningGroup = Box([HTML("<h3 class='text-lg font-bold'>● Run test</h3>"), HBox([btUpdateModel, HTML("<div id='lb-model' class='w-48 h-full flex flex-col text-sm self-center'><p id='lb-model-avg-loss' class='text-lg'>Avg loss: -</p><p id='lb-model-iteration' class='text-lg'>Iteration: -</p></div>"), btPrev, btNext, HTML("<div class='whitespace-nowrap px-8' id='lb'>0 / 0</div>"), HTML('''<div class="w-7" role="status">
...
display(
    ...
    <div class='flex items-end gap-4 mb-1'>
      ...
      <h1 class='text-2xl font-bold'>CiRA DeepTrain Jupyter</h1>
